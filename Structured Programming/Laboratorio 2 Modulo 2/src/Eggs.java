...
public class Eggs {
    ...
    public static double service_Selection(){
        Scanner sc = new Scanner(System.in);
        System.out.println("How many eggs? (1: Price for a dozen 2. Price per egg) 3. Price for both");
        double service= sc.nextInt();
        switch (service) {
            case 1:
                double serviceDozen = 8.50;
                System.out.println(serviceDozen);
                System.out.println("How many packages?");
                double packages = sc.nextInt();
                System.out.println("Correct?"+packages);
                double total = serviceDozen + packages;
                System.out.println(total);
                break;
                case 2:
                    double singleEgg =0.71;
                    System.out.println(singleEgg);
                    System.out.println("How many eggs?");
                    double eggs = sc.nextInt();
                    System.out.println("Price for eggs:"+eggs*singleEgg);
                    break;
                    case 3:
