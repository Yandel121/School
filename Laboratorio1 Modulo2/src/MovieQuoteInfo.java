...
public class MovieQuoteInfo{
    public static void main (String[] args) {
        ...
        //Este comando muestra una frase citada de una pelicula//
         ...
         //Este comando muestra la pelicula del quote mencionado//

        System.out.println("J.Robert Oppenheimer");
            //Este comando muestra el nombre de la persona que hízo la frase//

        System.out.println("2022");
            //Este comando muestra el año de la pelicula//
       }
    }
